...
import com.asma.mp.userInterface.activity.WebActivity
...
class ContactFragment : Fragment(R.layout.fragment_contact) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<LinearLayout>(R.id.instagram).setOnClickListener { onInstagramClicked() }
    }
    ...
    private fun onInstagramClicked() {
        val intent = Intent(Intent.ACTION_SENDTO)
        intent.putExtra(getString(R.string.intent_key), getString(R.string.my_instagram))
        startActivity(intent)
    }
